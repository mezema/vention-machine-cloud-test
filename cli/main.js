;(() => {
  var __webpack_modules__ = {
      857: (__unused_webpack_module, exports, __webpack_require__) => {
        Object.defineProperty(exports, "__esModule", { value: !0 }), (exports.EnforceFileFolderNamingConVention = void 0)
        const path_1 = (0, __webpack_require__(752).__importDefault)(__webpack_require__(17)),
          clipanion_1 = __webpack_require__(638),
          utils_1 = __webpack_require__(733)
        class EnforceFileFolderNamingConVention extends clipanion_1.Command {
          async execute() {
            ...
            if (errorPathPaths.length > 0) {
              ...
              console.error(errorMessage), console.error(errorPathPaths), process.exit(1)
            }
      ...
      351: (__unused_webpack_module, exports, __webpack_require__) => {
        Object.defineProperty(exports, "__esModule", { value: !0 }), (exports.EnforceValidImportsApi = void 0)
        const tslib_1 = __webpack_require__(752),
          fs_1 = (0, tslib_1.__importDefault)(__webpack_require__(147)),
          path_1 = (0, tslib_1.__importDefault)(__webpack_require__(17)),
          clipanion_1 = __webpack_require__(638),
          utils_1 = __webpack_require__(733)
        class EnforceValidImportsApi extends clipanion_1.Command {
          async execute() {
            const invalidImportRegex = /import .*ventionMachineCloudTest\/[a-zA-Z]+\//gm,
              fileContainingInvalidImports = []
            async function validateEntryName(entry) {
              ;(await fs_1.default.promises.readFile(entry, { encoding: "utf-8" })).match(invalidImportRegex) &&
            ...
            if (fileContainingInvalidImports.length > 0) {
              const errorMessage = `${fileContainingInvalidImports.length} file(s) have invalid imports. They should NOT look like this: "@ventionMachineCloudTest/models/something/entity"`
              console.error(errorMessage), console.error(fileContainingInvalidImports), process.exit(1)
            }
        ...
        ;(exports.EnforceValidImportsApi = EnforceValidImportsApi),
          ...
          (EnforceValidImportsApi.usage = clipanion_1.Command.Usage({
            ...
            examples: [["A basic example", "npm run ventionMachineCloudTest-cli enforce-valid-imports-api"]],
          }))
      },
      744: (__unused_webpack_module, exports, __webpack_require__) => {
        Object.defineProperty(exports, "__esModule", { value: !0 }), (exports.GenerateCacheKeyFile = void 0)
        const tslib_1 = __webpack_require__(752),
          fs_1 = (0, tslib_1.__importDefault)(__webpack_require__(147)),
          path_1 = (0, tslib_1.__importDefault)(__webpack_require__(17)),
          clipanion_1 = __webpack_require__(638),
          camelCase_1 = (0, tslib_1.__importDefault)(__webpack_require__(897)),
          capitalize_1 = (0, tslib_1.__importDefault)(__webpack_require__(969)),
          kebabCase_1 = (0, tslib_1.__importDefault)(__webpack_require__(546)),
          utils_1 = __webpack_require__(733)
        class GenerateCacheKeyFile extends clipanion_1.Command {
          async execute() {
            ...
            for await (const pathName of (0, utils_1.walk)(endpointsPath, [])) {
              if (fs_1.default.lstatSync(pathName).isFile() && pathName.includes("-endpoints")) {
                ...
                const endpointsSelectorRegex = /build => \(({[\s\S]+overrideExisting: false,\s+})/m,
                  endpointSelectorRegex = /([a-z-A-Z]+): build.[qm]/gm,
                  endpointNames = [
                    ...fs_1.default
                      .readFileSync(pathName, { encoding: "utf8" })
                      .match(endpointsSelectorRegex)[1]
                      .matchAll(endpointSelectorRegex),
                  ]
                ...
                endpointNames.length > 0 &&
                  ...
                  (cacheFileContent += `export const add${(0, capitalize_1.default)(
                    cacheKey
            ...
            ;(cacheFileContent = cacheFileContent.replace(
              "IMPORT_STATEMENTS",
              importStatements.map(importStatement => importStatement).join("\n")
            )),
              (cacheFileContent += `export const addGeneratedCacheKeys = () => {\n  ${cacheKeys
                .map(cacheKey => `add${(0, capitalize_1.default)(cacheKey)}CacheKeys()`)
                .join("\n")}\n}\n`),
      ...
      999: (__unused_webpack_module, exports, __webpack_require__) => {
        Object.defineProperty(exports, "__esModule", { value: !0 }), (exports.GenerateEntityIndexFile = void 0)
        const tslib_1 = __webpack_require__(752),
          fs_1 = (0, tslib_1.__importDefault)(__webpack_require__(147)),
          path_1 = (0, tslib_1.__importDefault)(__webpack_require__(17)),
          utils_1 = __webpack_require__(733),
        ...
        class GenerateEntityIndexFile extends clipanion_1.Command {
          async execute() {
            const entityIndexLockFilePath = path_1.default.join(__dirname, "entity-index-hash.txt"),
              indexFilePath = path_1.default.join(__dirname, "../libs/models/src/index.ts"),
              filePathsByFolder = {}
            for await (const entry of (0, utils_1.walk)(path_1.default.join(__dirname, "../libs/models/src/lib"), [])) {
              ...
              filePathsByFolder[folder] || (filePathsByFolder[folder] = []), filePathsByFolder[folder].push(entry)
            }
            ...
            const entityIndexLockFileExists = fs_1.default.existsSync(entityIndexLockFilePath),
              existingEntityHash = parseInt(
                entityIndexLockFileExists ? await fs_1.default.promises.readFile(entityIndexLockFilePath, { encoding: "utf8" }) : ""
              ),
              currentHash = (function (str) {
                let i,
                  chr,
                  hash = 0
            ...
            existingEntityHash !== currentHash &&
        ...
        function getExportLinesFromFilePaths(filePaths) {
          return filePaths
            .sort()
            .map(filePath => `export * from "./${filePath.split("src/")[1].replace(".ts", "")}"\n`)
            .join("")
        }
        ;(exports.GenerateEntityIndexFile = GenerateEntityIndexFile),
          ...
          (GenerateEntityIndexFile.usage = clipanion_1.Command.Usage({
            ...
            examples: [["A basic example", "npm run ventionMachineCloudTest-cli generate-entity-index-file"]],
          }))
      },
      28: (__unused_webpack_module, exports, __webpack_require__) => {
        Object.defineProperty(exports, "__esModule", { value: !0 }), (exports.RenameProject = void 0)
        const tslib_1 = __webpack_require__(752),
          fs_1 = (0, tslib_1.__importDefault)(__webpack_require__(147)),
          path_1 = (0, tslib_1.__importDefault)(__webpack_require__(17)),
          clipanion_1 = __webpack_require__(638),
          lodash_1 = __webpack_require__(517),
          utils_1 = __webpack_require__(733)
        class RenameProject extends clipanion_1.Command {
          constructor() {
            super(...arguments),
              (this.organization = clipanion_1.Option.String("--organization", { required: !0 })),
              (this.project = clipanion_1.Option.String("--project", { required: !0 }))
          }
          async execute() {
          ...
          async renameProject() {
            try {
              ;/^[a-zA-Z-\d_]+$/gim.test(this.organization) ||
                (console.error("The organization name must respect this regex /^[a-zA-Z-\\d_]+$/gmi"), process.exit(1))
              ;/^[a-zA-Z-\d_]+$/gim.test(this.project) ||
                (console.error("The project name must respect this regex /^[a-zA-Z-\\d_]+$/gmi"), process.exit(1))
              const databaseName = this.project.replace(/-/g, "_"),
                databaseFiles = ["docker-compose.yml", "seed-data.js", "init.sql", "test.ts", "orm-config.ts"],
                camelCaseProjectName = (0, lodash_1.camelCase)(this.project),
                ignoredFolders = ["node_modules", "dist", ".git", ".idea", ".cache"]
              for await (const entry of (0, utils_1.walk)(path_1.default.join(__dirname, "../"), ignoredFolders)) {
                if ((await fs_1.default.promises.lstat(entry)).isFile()) {
                  ...
                  if (fileContent) {
                    const isDatabaseFile = databaseFiles.some(databaseFile => entry.includes(databaseFile)),
                      replacedFileContent = fileContent
                        .replace(/Vention/gim, this.organization)
        ...
        ;(exports.RenameProject = RenameProject),
          ...
          (RenameProject.usage = clipanion_1.Command.Usage({
            ...
            examples: [
              [
                "A basic example",
                "npm run ventionMachineCloudTest-cli rename-project --organization Vention --project ventionMachineCloudTest",
              ],
            ],
          }))
      },
      733: (__unused_webpack_module, exports, __webpack_require__) => {
        Object.defineProperty(exports, "__esModule", { value: !0 }), (exports.walk = void 0)
        const tslib_1 = __webpack_require__(752),
          fs_1 = (0, tslib_1.__importDefault)(__webpack_require__(147)),
          path_1 = (0, tslib_1.__importDefault)(__webpack_require__(17))
        exports.walk = async function* (dir, ignoredPaths, walkedFolderNames = []) {
          for await (const directoryEntry of await fs_1.default.promises.opendir(dir)) {
            ...
            directoryEntry.isDirectory() && !ignoredPaths.includes(directoryEntry.name)
              ? (walkedFolderNames.push(entryPath), yield* (0, exports.walk)(entryPath, ignoredPaths, walkedFolderNames))
              : directoryEntry.isFile() && (yield entryPath)
          }
        }
      },
      638: module => {
  ...
  ;(() => {
    ...
    const clipanion_1 = __webpack_require__(638),
      enforce_file_folder_naming_conVention_1 = __webpack_require__(857),
      enforce_valid_imports_api_1 = __webpack_require__(351),
      generate_cache_key_file_1 = __webpack_require__(744),
      generate_entity_index_file_1 = __webpack_require__(999),
      rename_project_1 = __webpack_require__(28),
      [, , ...args] = process.argv,
      cli = new clipanion_1.Cli({
